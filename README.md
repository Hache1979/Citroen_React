...
Citroen_Argentina is a react development (WIP), created as a small version of the current Citroën site. The project was built from scratch, and was empowered using react-Bootstrap plugins. The structure is simple and the site navegation is really intuitive (very easy to use). 
